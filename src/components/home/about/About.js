    ...
    return (
        <div className="home-section container-about">
            ...
            <div className="about-text">
                <span className="about-text-main">Hi! I'm <span className="about-name">Thomas Ong</span></span>
                <br/><span className="about-text-subtitle">I'm a software engineer @Oracle</span>
                <br/><br/>I like to build things with code
                <br/>Some of my interests are: Android, Web development, e-business development, VR and computer graphics.
